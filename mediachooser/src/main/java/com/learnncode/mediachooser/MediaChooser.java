...
public class MediaChooser {
    ...
    public static void setMaxVideoDuration(int second){
        MediaChooserConstants.SELECTED_VIDEO_SIZE_DURATION = second;
    }
...
//    }
    ...
    public static void setMaxMediaLimit(int videoMax, int pictureMax) {
        MediaChooserConstants.MAX_VIDEO_LIMIT = videoMax;
        MediaChooserConstants.MAX_IMG_LIMIT = pictureMax;
