...
//			int textSize=getResources().getDimensionPixelOffset(R.dimen.text_size_tab_host_title);
				...
				if(videoFragment != null || imageFragment != null){
					...
					if(videoFragment != null){
						if(videoFragment.getSelectedVideoList() != null && videoFragment.getSelectedVideoList() .size() > 0){
							...
							intentAll.putStringArrayListExtra("listVideo", videoFragment.getSelectedVideoList());
					...
					if(imageFragment != null){
						if(imageFragment.getSelectedImageList() != null && imageFragment.getSelectedImageList().size() > 0){
							...
							intentAll.putStringArrayListExtra("listPicture", imageFragment.getSelectedImageList());
