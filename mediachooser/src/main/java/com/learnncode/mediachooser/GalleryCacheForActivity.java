...
public class GalleryCacheForActivity {
	private LruCache<String, Bitmap> mBitmapCache;
	private ArrayList<String> mCurrentTasks;
	private int mMaxWidth;

	public GalleryCacheForActivity(int size, int maxWidth, int maxHeight) {
		mMaxWidth = maxWidth;
...
//				}
	...
	private class BitmapLoaderTask extends AsyncTask<Void, Void, Bitmap> {
		...
		public BitmapLoaderTask(String imageKey, BaseAdapter adapter){
		...
		protected void onPostExecute(Bitmap param) {
			...
			if (param != null) {
				...
				}else if(null!=mBucketGridAdapter){
