...
public class VideoLoadForActivity extends MediaAsync<String,String, String>{
	...
	public VideoLoadForActivity(Activity activity, ImageView imageView, boolean isScrolling, int width) {
