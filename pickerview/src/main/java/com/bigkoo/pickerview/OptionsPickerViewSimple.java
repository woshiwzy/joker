 ...
 */
public class OptionsPickerViewSimple<T> extends BasePickerView implements View.OnClickListener {
    WheelOptions wheelOptions;
    private TextView tvTitle;
    private OnOptionsSelectListener optionsSelectListener;
    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";
    public OptionsPickerViewSimple(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.pickerview_options_simple, contentContainer);
        //顶部标题
    ...
    public int getCurrent(){
        ...
        return wheelOptions.getCurrentItems()[0];
    }
