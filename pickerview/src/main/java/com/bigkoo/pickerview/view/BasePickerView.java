...
public class BasePickerView {
    ...
    public ViewGroup decorView;//activity的根View
    ...
    public void removeOlderDialogView(){

        View oldView = decorView.findViewById(com.bigkoo.pickerview.R.id.outmost_container);
        if (null != oldView) {
